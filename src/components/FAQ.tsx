    ...
    <div className="max-w-2xl mx-auto mt-8">
      ...
      <Accordion type="single" collapsible className="w-full">
        ...
        <AccordionItem value="older-cars">
          ...
          <AccordionContent className="text-left">
            Car data from the EPA only reaches back to 2013. Beyond this, statistics and data are less dependable. Still, you can get a good general estimate of the value grade of the vehicle. For cars older than 2013, we recommend just using year 2013.
          </AccordionContent>
        </AccordionItem>
